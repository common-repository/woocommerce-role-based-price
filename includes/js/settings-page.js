...
( function ($, window, document, undefined) {
    ...
    $(document).ready(function () {
        if ( jQuery('div.wc_rbp_addon_listing').length > 0 ) {
        ...
        jQuery('.wc_rbp_settings_submenu a').on("click",$.WCRBP_SETTINGS.settings_click_handler);

        if ( jQuery('.wc_rbp_settings_submenu').length > 0 ) {
        ...
        jQuery('ul.wc_rbp_addons_category li a').each(function () {
            ...
            var catCount = jQuery('.wc-rbp-addon-' + category).length;
